...
for _ in range(1000):
    ...
    new_z = z_function(X_new, Y_new)
    ax.plot_surface(X, Y, Z, cmap="viridis", zorder=0)
    ax.scatter(current_pos1[0], current_pos1[1], current_pos1[2], c='magenta', zorder=1)
    ax.scatter(current_pos2[0], current_pos2[1], current_pos2[2], c='orange', zorder=1)
    ax.scatter(current_pos3[0], current_pos3[1], current_pos3[2], c='green', zorder=1)
    plt.pause(0.001)
    ax.clear()
